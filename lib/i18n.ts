...
const translations: Record<Lang, Translations> = {
  ko: {
    ...
    linkCopied: '링크 복사됨!',
    shareTo: 'SNS 공유',
    imageShareBtn: '이미지 저장',
    imageSharing: '이미지 생성 중...',
    imageSaved: '저장됨! 갤러리에서 공유하세요',
  ...
  en: {
    ...
    shareTo: 'Share',
    imageShareBtn: 'Save Image',
    imageSharing: 'Generating...',
    imageSaved: 'Saved! Share from gallery',
