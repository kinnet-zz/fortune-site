...
const translations: Record<Lang, Translations> = {
  ko: {
    ...
    howToSteps: [
      ...
      { title: '운세 확인', desc: '별자리와 띠의 상징을 바탕으로 오늘의 종합운, 연애운, 금전운, 직업운을 참고용으로 확인합니다.' },
    ],
    ...
    serviceIntroText: '오늘의 운세는 생년월일을 기반으로 서양 별자리(12궁도)와 동양 띠를 함께 계산하고, 각 상징을 오늘의 자기성찰 문장으로 풀어보는 무료 참고 도구입니다. 종합운, 연애운, 금전운, 직업운과 행운의 색·숫자를 제공하지만 실제 미래를 예측하지 않습니다.',
    ...
    aboutSubtitle: '별자리와 띠를 문화적 맥락으로 읽는 무료 운세 해석 가이드',
    missionTitle: '서비스 목적',
    missionText1: '<strong>오늘의 운세</strong>는 바쁜 일상 속에서 간편하게 오늘의 운세를 확인하고 싶은 분들을 위해 만들어진 무료 서비스입니다.',
    missionText2: '생년월일 하나만 입력하면 서양의 12별자리(황도대 점성술)와 동양의 12띠를 동시에 계산하고, 오늘 날짜에 맞는 참고용 운세 문장으로 정리해 드립니다.',
    missionText3: '종합운, 연애운, 금전운, 직업운의 네 가지 분야와 함께 오늘의 행운의 색, 행운의 숫자까지 알려드려 하루를 더 긍정적으로 시작할 수 있도록 도와드립니다.',
    missionNote: '※ 본 서비스의 운세는 오락 및 자기성찰 목적으로 제공되는 참고 콘텐츠입니다. 실제 미래를 예측하거나 과학적 근거가 있는 내용이 아님을 안내해 드립니다.',
    featuresTitle: '서비스 특징',
    featureItems: [
      { icon: '🔮', title: '오늘의 해석 문장', desc: '별자리와 띠의 상징, 오늘 날짜를 함께 참고해 종합운·연애운·금전운·직업운을 읽기 쉬운 문장으로 제공합니다.' },
    ...
    aiSystemTitle: '운세 해석 도구 작동 방식',
    aiSystemSteps: [
      { title: '입력 정보 분석', desc: '생년월일과 성별을 입력받아 서양 별자리(황도 12궁)와 동양 12띠를 자동 계산합니다.' },
      { title: '해석 문장 구성', desc: '오늘 날짜, 별자리 특성, 띠의 성격을 종합하여 오락 및 자기성찰 목적의 운세 텍스트를 구성합니다.' },
      { title: '결과 제공', desc: '종합운, 연애운, 금전운, 직업운과 함께 운세 점수(100점 만점), 행운의 색, 행운의 숫자를 제공합니다.' },
    ],
    faqTitle: '자주 묻는 질문 (FAQ)',
    faqItems: [
      { q: '운세는 얼마나 정확한가요?', a: '본 서비스의 운세는 오락과 자기성찰을 위한 참고 콘텐츠입니다. 실제 미래를 과학적으로 예측하거나 보장하지 않습니다. 가볍게 재미로 즐겨주세요.' },
    ...
    footerDesc: '별자리와 띠를 문화적 맥락으로 읽는 무료 운세 해석 가이드. 오늘의 종합운, 연애운, 금전운, 직업운을 참고용으로 확인해보세요.',
    footerService: '서비스',
    footerPolicy: '정책',
    footerPrivacy: '개인정보처리방침',
    footerTerms: '이용약관',
    footerContact: '문의하기',
    footerDisclaimer: '본 서비스의 운세는 오락 및 자기성찰 목적의 참고 콘텐츠입니다. 실제 미래를 예측하지 않습니다.',
  },
