...
const ARTICLES = [
  ...
  {
    slug: 'barnum-effect-astrology',
    title: "MBTI보다 정교한 '운명의 알고리즘': 왜 우리는 여전히 별자리에 열광하는가?",
    description: '1948년 포러 실험에서 시작된 바넘 효과. 왜 별자리 설명은 항상 "나한테 딱 맞는 것 같은가"? 심리학 연구로 분석한 별자리 신뢰의 메커니즘.',
    date: '2025년 7월 8일',
    readTime: '11분',
    category: '심리 분석',
    emoji: '🧠',
  ...
  {
    slug: 'morning-fortune-ritual',
    title: "운명을 바꾸는 아침 5분: StarFate가 제안하는 나만의 운세 활용법",
    description: '골위처의 실행 의도 연구, 점화 효과, 자아 고갈 이론으로 설계한 아침 운세 루틴. 운세를 예언이 아닌 의도 설정 도구로 활용하는 5단계 방법.',
    date: '2025년 7월 15일',
    readTime: '8분',
    category: '리추얼 라이프',
    emoji: '🌅',
  ...
  {
    slug: 'twin-study-astrology',
    title: '같은 날 태어난 2,000명을 추적했다 — 쌍둥이 연구가 별자리에 던진 가장 불편한 질문',
    description: '제프리 딘의 타임트윈 연구, 숀 칼슨의 Nature 이중맹검 실험, 화성 효과 재현 실패까지. 데이터가 말하는 별자리의 예측력과 그럼에도 우리가 별자리를 보는 이유.',
    date: '2025년 8월 5일',
    readTime: '10분',
    category: '데이터 분석',
    emoji: '👯',
  },
  {
    ...
    description: '시리우스 헬리아칼 라이징, 덴데라 조디악, 프톨레마이오스의 테트라비블로스까지. 케플러와 갈릴레오도 점성술 차트를 그렸던 시절의 이야기.',
    date: '2025년 8월 12일',
    readTime: '12분',
    category: '별자리 역사',
    emoji: '🏛️',
  ...
  {
    slug: 'zodiac-personality-deep-dive',
  ...
  {
    slug: 'astrology-psychology-science',
  ...
  {
    slug: 'chinese-zodiac-history',
    title: '동양 12지(십이지) 완벽 역사 가이드 — 기원, 신화, 음양오행 원리',
    description: '쥐부터 돼지까지 12지 동물의 기원 신화, 음양오행 철학, 역사적 발전 과정을 체계적으로 정리합니다. 왜 이 12동물이 선택됐는지 깊이 있게 탐구합니다.',
    date: '2026년 4월 8일',
    readTime: '13분',
    category: '동양철학 역사',
    emoji: '🐉',
  ...
  {
    slug: 'birth-chart-beginner-guide',
    title: '출생 차트(Birth Chart) 완전 초보 가이드 — 태양·달·상승 별자리 읽는 법',
    description: '출생 차트의 기초부터 태양 별자리, 달 별자리, 상승 별자리 계산 방법과 해석법을 단계별로 설명합니다. 점성술을 처음 접하는 분을 위한 완전 가이드입니다.',
    date: '2026년 4월 10일',
    readTime: '11분',
    category: '점성술 입문',
    emoji: '🗺️',
