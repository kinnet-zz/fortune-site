...
const content = {
  ko: {
    ...
    s1Items: [
      ...
      { label: '접속 로그(IP, 브라우저 정보)', desc: ': 서비스 안정성 유지 및 부정 이용 방지 목적으로 Vercel 서버에 자동 수집됩니다.' },
      { label: '쿠키 및 광고 데이터', desc: ': Google AdSense를 통해 맞춤 광고 제공 목적으로 수집될 수 있습니다.' },
    ],
    s2Title: '2. 개인정보 보유 및 이용 기간',
    s2Body: '생년월일은 운세 생성 후 즉시 파기되며 별도로 저장되지 않습니다. 접속 로그는 Vercel 정책에 따라 최대 30일간 보관 후 자동 삭제됩니다.',
  ...
  en: {
    ...
    s1Items: [
      ...
      { label: 'Access logs (IP, browser info)', desc: ': Automatically collected by Vercel servers to maintain service stability and prevent abuse.' },
    ...
    s2Body: 'Date of birth is immediately discarded after fortune generation and is not stored separately. Access logs are automatically deleted after a maximum of 30 days in accordance with Vercel\'s policy.',
    ...
    s4Rows: [
      ...
      ['Vercel Inc.', 'Server hosting and log management'],
  ...
  zh: {
    ...
    s1Items: [
      ...
      { label: '访问日志（IP、浏览器信息）', desc: '：由Vercel服务器自动收集，用于维护服务稳定性及防止滥用。' },
      { label: 'Cookie及广告数据', desc: '：可能通过Google AdSense收集，用于提供个性化广告。' },
    ],
    s2Title: '2. 个人信息保留期限',
    s2Body: '出生日期在生成运势后立即销毁，不单独存储。访问日志根据Vercel政策最多保留30天后自动删除。',
  ...
  ja: {
    ...
    s1Items: [
      ...
      { label: 'アクセスログ（IP・ブラウザ情報）', desc: '：サービスの安定性維持および不正利用防止のため、Vercelサーバーに自動収集されます。' },
      { label: 'Cookieおよび広告データ', desc: '：Google AdSenseを通じてパーソナライズ広告の配信を目的として収集される場合があります。' },
    ],
    s2Title: '2. 個人情報の保持期間',
    s2Body: '生年月日は運勢生成後に即座に破棄され、別途保存されません。アクセスログはVercelのポリシーに従い、最大30日間保管後に自動削除されます。',
